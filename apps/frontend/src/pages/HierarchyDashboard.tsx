...
export default function HierarchyDashboard() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/20 to-indigo-50/20 flex">
      {/* Sidebar - Proporcional e Moderna - Responsiva */}
      <div className={`fixed lg:static inset-y-0 left-0 z-50 w-64 bg-white border-r border-slate-200 flex flex-col shadow-lg flex-shrink-0 transform transition-transform duration-300 ${
        ...
        <div className="p-5 border-b border-slate-200 relative">
          ...
          <button
            ...
            className="lg:hidden absolute top-4 right-4 p-2 rounded-lg hover:bg-slate-100 transition-colors z-10"
          >
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Top Bar - Responsiva */}
        <div className="bg-white border-b border-slate-200 px-4 md:px-6 py-4 flex items-center justify-between flex-shrink-0">
          <div className="flex items-center gap-2 md:gap-3 flex-1">
            ...
            <span className="hidden sm:inline w-2 h-2 rounded-full bg-emerald-400 pulse-soft"></span>
            <span className="hidden sm:inline text-sm font-semibold text-slate-700">Sistema Aletheia em funcionamento</span>
            <span className="px-2.5 py-1 rounded-full bg-emerald-100 text-emerald-700 text-xs font-semibold">Online</span>
          </div>
          <div className="flex items-center gap-2 md:gap-3">
            <input
              placeholder="Buscar..."
              className="hidden md:block px-4 py-2 rounded-lg border border-slate-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm w-48 lg:w-64"
            />
        ...
        <div className="flex-1 overflow-y-auto">
          <div className="max-w-7xl mx-auto p-4 md:p-6">
            {/* Banner Principal */}
            <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 rounded-2xl p-6 md:p-8 mb-6 text-white shadow-xl">
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex-1">
                  <div className="text-2xl md:text-4xl font-extrabold mb-2">Painel Aletheia</div>
                  <div className="text-blue-100 text-sm md:text-lg mb-4">Acesso rápido aos módulos do sistema</div>
